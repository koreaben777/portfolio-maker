...
로컬 파일 후보는 최대 500개, GitHub 저장소·PR·Issue 명령은 최대 100개까지 요청합니다. GitHub activity endpoint는 페이지를 자동으로 끝까지 읽지 않으며, 요청 한도에 도달한 endpoint는 incomplete로 기록해 기존 activity visibility를 철회하지 않습니다.
