...
> 현재 버전은 **근거 기반 마스터 프로필**과 **검토가 필요한 포트폴리오 뼈대**를 제공합니다. 역할·기술적 접근·성과를 근거와 함께 작성하는 회사별 맞춤 포트폴리오는 후속 확장입니다. 다음 우선 단계는 본인과 방문자가 함께 확인할 수 있는 일반형 공개 인터랙티브 HTML 포트폴리오입니다.
